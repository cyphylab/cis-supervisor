...
for i = 1:5
    ...
    [x_up, u_up, b, exitflag,info] = optimizerETH(TrackMPC,MPC_vars,ModelParams, n_cars, Y, x, u, x0, uprev);
...
for i = 1: simN
    ...
    %  formulate MPCC problem and solve it
    if QP_iter == 0
        [x, u, b, exitflag,info] = optimizerETH(TrackMPC,MPC_vars,ModelParams, n_cars, Y, x, u, x0, uprev);
