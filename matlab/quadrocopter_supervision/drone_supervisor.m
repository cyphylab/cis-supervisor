...
safe_distance = 0.5;
% Use IRIS:
% [Sp, Obs] = generateSafeRegion_IRIS(obstacle_centers, safe_distance, Gp_range, Fp_range);
% Semi-manual:
[Sp, Obs] = generateSafeRegion_Manual(obstacle_centers, safe_distance);

% AdjMat = generateNeighborMap(Sp);
...
save('./data/InvariantSets.mat', "DSets");
%}
importedData = load('./data/InvariantSets.mat');
DSets = importedData.DSets;
...
% % Test velocity range:
% testcisV = DSets{1}.CIS.projection(4:6,'ifourier');
% plot(testcisV)
%%
