...
%
% Auto-generated by MATLAB on 16-Feb-2021 17:37:13
...
opts.VariableNames = ["time", "fieldheaderseq", "fieldheaderstamp", "fieldheaderframe_id", "fieldjerk_body0", "fieldjerk_body1", "fieldjerk_body2", "fieldthrust", "fieldyaw_rate", "fieldang_velocity0", "fieldang_velocity1", "fieldang_velocity2", "fieldstate_curr0", "fieldstate_curr1", "fieldstate_curr2", "fieldstate_curr3", "fieldstate_curr4", "fieldstate_curr5", "fieldstate_curr6", "fieldstate_curr7", "fieldstate_curr8", "fieldstate_pred0", "fieldstate_pred1", "fieldstate_pred2", "fieldstate_pred3", "fieldstate_pred4", "fieldstate_pred5", "fieldstate_pred6", "fieldstate_pred7", "fieldstate_pred8", "fieldactive"];
opts.VariableTypes = ["double", "double", "double", "string", "double", "double", "double", "double", "double", "double", "double", "double", "double", "double", "double", "double", "double", "double", "double", "double", "double", "double", "double", "double", "double", "double", "double", "double", "double", "double", "double"];
